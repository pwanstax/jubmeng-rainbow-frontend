...
const MapPage = () => {
  ...
  const [center, setCenter] = useState({lat: 13.75, lng: 100.53});

  return (
    <div className="mappage-container">
      <div className="product-view">
        <MapProductView productList={productList} setCenter={setCenter} />
      </div>
      <Map productList={productList} center={center} setCenter={setCenter} />
    </div>
  );
};
